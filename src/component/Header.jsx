...
export const Header = () => {
      ...
      await axios.get(url).then((res) => {
        if (res !== null) {
          res.data.data.map((countryName, index) => {
            countryList.push(countryName.country);
          });
        }
      });
    } catch (error) {
  ...
  return (
    <header>
      <div className="header-main-top pt-5">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-2">
              <Link to={"/"}> Nest App </Link>
            </div>
                  ...
                  <ul className="d-flex align-items-center justify-content-between">
                    <li>
                      <div className="header-item d-flex align-items-center">
                        <i className="fa-solid fa-code-compare me-1"></i>
                        <p>Compare</p>
                      </div>
                    </li>
                    <li>
      ...
      <div className="navigation-row py-3 mt-5">
        <Navigation />
      </div>
    </header>
  );
